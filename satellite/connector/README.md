...
If you need to open specific flows at your firewall level in order allow VPPN traffic to the Satellite Relay, refer to this [page](https://cloud.ibm.com/docs/satellite?topic=satellite-understand-connectors#network-requirements).
